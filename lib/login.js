   ...
   self.createToken(email, function (error, token) {
     if (error) {
       ...
       var mailOptions = {
         ...
         html: self.language.getString(languageString, 'reset_mail_text') + '<br/><a href="https://www.storytellingclub.de/set-pwd?resetToken=' + token + '&email=' + email + '">' + self.language.getString(languageString, 'reset_mail_button') + '</a>' // html body
       }
       ...
       self.database.addUser(dataset, function (err, user) {
         if (err) {
           ...
           var mailOptions = {
             ...
             html: self.language.getString(user.language, 'register_mail_text') + '<br/><a href="https://www.storytellingclub.de/app">' + self.language.getString(user.language, 'register_mail_button') + '</a><br/><br/><br/><h4>' + self.language.getString(user.language, 'mail_data') + '</h4><table><tr><td>' + self.language.getString(user.language, 'login_language') + '</td><td>' + send.language + '</td></tr><tr><td>' + self.language.getString(user.language, 'login_email') + '</td><td>' + dataset.register_email + '</td></tr><tr><td>' + self.language.getString(user.language, 'login_vorname') + '</td><td>' + dataset.register_vorname + '</td></tr><tr><td>' + self.language.getString(user.language, 'login_nachname') + '</td><td>' + dataset.register_nachname + '</td></tr></table><br/><br/><br/>' + self.language.getString(user.language, 'mail_noreply') // html body
           }
           self.transporter.sendMail(mailOptions, function (error, info) {
            if (error) {
              console.error(error)
