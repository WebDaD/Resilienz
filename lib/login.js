   ...
   self.createToken(email, function (error, token) {
     if (error) {
       ...
       var mailOptions = {
         ...
         html: self.language.getString(languageString, 'reset_mail_text') + '<br/><a href="http://46.38.254.190:8080/set-pwd?resetToken=' + token + '&email=' + email + '">' + self.language.getString(languageString, 'reset_mail_button') + '</a>' // html body
       }
