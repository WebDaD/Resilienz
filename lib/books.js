...
function printTextField (target, object, font, size, color) { // -> adds text to page
  var cmd = 'convert ' + target + ' -size ' + object.width + 'x' + object.height + ' -family "' + font + '" -pointsize ' + color + ' -density 27.8x28.2 -fill "' + color + '" -annotate +' + object.x + '+' + object.y + ' "' + object.value + '" ' + target
  console.log(cmd)
