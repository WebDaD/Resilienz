...
function printTextField (target, object) { // -> adds text to page
  ...
  var cmd = 'convert ' + target + ' -size ' + object.width + 'x' + object.height + ' -family Helvetica -pointsize 198 -density 27.8x28.2 -fill blue -annotate +' + object.x + '+' + object.y + ' "' + text + '" ' + target
  console.log(cmd)
