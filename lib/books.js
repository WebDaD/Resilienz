...
function printTextField (target, object) { // -> adds text to page
  ...
  var cmd = 'convert ' + target + ' -size ' + object.width + 'x' + object.height + ' -family "Tempus Sans ITC TT" -pointsize 198 -density 27.8x28.2 -fill "#008ae1" -annotate +' + object.x + '+' + object.y + ' "' + text + '" ' + target
  console.log(cmd)
...
function printNumber (actionid, page) { // -> prints number on page
  var cmd1 = 'convert ' + page.path + ' -font Helvetica -pointsize 24 -gravity southwest -stroke \'#000C\' -strokewidth 2 -annotate +50+10 \'' + page.realNumber + '\' -stroke none -fill white -annotate +50+10 \'' + page.realNumber + '\' ' + page.path
  console.log(cmd1)
