          ...
          if (page === 2) {
            ...
            for (var i = 0; i < information.length; i++) {
              ...
              if (info.type === 'image') {
                ...
                var size = info.value.split('|')[0]
                cmd = 'convert -font Helvetica -pointsize ' + size + ' -background white -fill black -gravity west -geometry \'' + info.width + 'x' + info.height + '!+' + info.x + '+' + info.y + '\' caption:"' + text + '" ' + bg + ' +swap -gravity northwest -composite  ' + target
                console.log(cmd)
                output = execSync(cmd, true)
              }
            }
