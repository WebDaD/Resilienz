        ...
        if (error) {
          ...
          if (page === 2) {
            ...
            if (output.stderr) {
              ...
              self.printNumbers(self.pagespath + '/' + actionid + '/' + page + '_two.png', page, function(error) {
                if (error) {
                  callback(null, false)
                } else {
                  callback(null, true)
            ...
            if (output.stderr || output.stdout) {
              ...
              self.printNumbers(target, page, function(error) {
                if (error) {
                  callback(null, false)
                } else {
                  callback(null, true)
...
function printNumbers(target, page,callback) {
