          ...
          if (page === 2) {
            ...
            for (var i = 0; i < information.length; i++) {
              ...
              if (info.type === 'image') {
                ...
                // TODO: remove 10% from width / height and add valued to x / y for centering
                cmd = 'convert -font Helvetica -pointsize 200 -background white -fill \'#1e487a\' -gravity northwest -geometry \'' + info.width + 'x' + info.height + '!+' + info.x + '+' + info.y + '\' caption:"' + text + '" ' + bg + ' +swap -gravity northwest -composite  ' + target
                console.log(cmd)
                output = execSync(cmd, true)
              }
            }
