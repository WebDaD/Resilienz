 ...
 */
             ...
             if (error) {
               ...
               composeFiles(self.layouter, self.pagespath, actionid, language, self.pages, function (error, parm) {
                 if (error) {
                   ...
                   makePDF(self.layouter, self.bookpath, parm, actionid, function (error) {
                     if (error) {
                       callback(error)
                     } else {
 ...
 function makePDF (layouter, bookpath, parameters, actionid, callback) {
   var parameter = ''
   var i = 1
   ...
   var cmd = 'convert ' + parameter + '  -density 27.8x28 -page a4 -compress Zip ' + bookpath + '/' + actionid + '.pdf'
   console.log(cmd)
