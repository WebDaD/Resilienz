    ...
    link: function postLink (scope, element, attrs) {
      if (element[0].tagName == 'IMG') {
        // do your stuff
        	...
        	if (scope.ngImgAreaSelectOptions === undefined) {
        		scope.ngImgAreaSelectOptions = {}
        	}
        scope.ngImgAreaSelectOptions.instance = true
        	scope.ngImgAreaSelectOptions.onSelectChange = function (img, selection) {
        ...
        var imgArea = angular.element(element).imgAreaSelect(scope.ngImgAreaSelectOptions)
